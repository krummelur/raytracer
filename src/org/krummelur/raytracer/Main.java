...
public class Main {
    ...
    renderer.world.addObject3d(new Sphere(new Vector3(0,0, 0), 1, new Vector3(0,1,0)));
    renderer.world.addObject3d(new Sphere(new Vector3(0.5,1,0), 0.5, new Vector3(1,1,0)));
    renderer.world.addObject3d(new Sphere(new Vector3(-0.5,-1,0), 0.5, new Vector3(0,1,1)));
    renderer.world.addObject3d(new Sphere(new Vector3(0.5,0,1), 0.5, new Vector3(1,1,1)));
    renderer.world.addObject3d(new Sphere(new Vector3(-0.5,0,-1), 0.5, new Vector3(1,0,1)));
